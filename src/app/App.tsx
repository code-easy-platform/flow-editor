...
const items: FlowItem[] = [
    new FlowItem({ id: '1', connections: [{ id: '0', connectionId: '2' }], isDisabled:true, top: 105, left: 90, name: "START", itemType: ItemType.START }),
    new FlowItem({ id: '2', connections: [{ id: '1', connectionId: '3', connectionLabel: 'True' }, { id: '8', connectionId: '0' }], top: 210, left: 90, name: "IF", itemType: ItemType.IF }),
    new FlowItem({ id: '3', connections: [{ id: '2', connectionId: '4', connectionLabel: 'Circle' }, { id: '9', connectionId: '5' }], top: 370, left: 90, name: "FOREACH", itemType: ItemType.FOREACH }),
    new FlowItem({ id: '4', connections: [{ id: '3', connectionId: '3' }], top: 370, left: 280, name: "ACTION", itemType: ItemType.ACTION }),
    new FlowItem({ id: '5', connections: [{ id: '4', connectionId: '6' }], top: 525, left: 90, name: "SWITCH", itemType: ItemType.SWITCH }),
    new FlowItem({ id: '6', connections: [{ id: '5', connectionId: '7' }], top: 630, left: 90, name: "ASSIGN", itemType: ItemType.ASSIGN }),
    new FlowItem({ id: '7', connections: [{ id: '6', connectionId: '0' }], top: 735, left: 90, name: "END", itemType: ItemType.END }),
    new FlowItem({ id: '8', connections: [{ id: '7', connectionId: '0' }], top: 105, left: 200, name: `COMMENT`, itemType: ItemType.COMMENT }),
];
