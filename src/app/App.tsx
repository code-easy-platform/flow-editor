...
const itens: FlowItem[] = [
  ...
  new FlowItem({ id: 3, sucessorId: 4, top: 300, left: 80, width: 50, height: 50, isSelecionado: false, nome: "FOREACH", itemType: ItemType.ASSIGN }),
  ...
  new FlowItem({ id: 5, sucessorId: 6, top: 500, left: 80, width: 50, height: 50, isSelecionado: false, nome: "SWICTH", itemType: ItemType.ASSIGN }),
...
const itensLogica: FlowItem[] = [
  ...
  new FlowItem({ id: 4, sucessorId: 0, top: 0, left: 0, width: 0, height: 0, isSelecionado: false, nome: "FOREACH", itemType: ItemType.ASSIGN }),
  new FlowItem({ id: 6, sucessorId: 0, top: 0, left: 0, width: 0, height: 0, isSelecionado: false, nome: "SWICTH", itemType: ItemType.ASSIGN }),
