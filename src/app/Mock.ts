...
export const newItemsLogical: NewFlowItem[] = [
    { id: '1', icon: IconFlowStart, description: 'Minha descrição legal', flowItemType: EFlowItemType.acorn, left: 80, top: 100, height: 40, width: 40 },
    { id: '2', icon: IconFlowStart, description: 'Minha descrição legal', flowItemType: EFlowItemType.acorn, left: 80, top: 200, height: 40, width: 40 },
    { id: '3', icon: IconFlowStart, description: 'Minha descrição legal', flowItemType: EFlowItemType.acorn, left: 80, top: 300, height: 40, width: 40 },
    { id: '4', icon: IconFlowStart, description: 'Minha descrição legal', flowItemType: EFlowItemType.acorn, left: 80, top: 400, height: 40, width: 40 },
    { id: '5', icon: IconFlowStart, description: 'Minha descrição legal', flowItemType: EFlowItemType.acorn, left: 80, top: 500, height: 40, width: 40 },
]
