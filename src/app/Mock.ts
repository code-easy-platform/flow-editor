...
export const ItemsLogical: IFlowItem[] = [
    ...
    { id: '6', itemType: EItemType.COMMENT, isEnabledNewConnetion: true, connections: [], description: 'Write here your comment\nWrite here your comment\nWrite here your comment', flowItemType: EFlowItemType.comment, left: 210, top: 200 },
]
